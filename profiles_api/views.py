...
class HelloViewSet(viewsets.ViewSet):
    ...
    def partial_update(self, request, pk=None):
        """Handle updaring part of an object"""
        return Response({'http_method': 'PATCH'})


    def destroy(self, request, pk=None):
        """Handle removiing an object"""
...
class UserProfileViewSet(viewsets.ModelViewSet):
    ...
    # django takes care of all ouer data handling described in serialzers
    # we need onley pass this 2 things
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    # sets basic funcionality to display values
    permission_classes = (permissions.UpdateOwnStatus, IsAuthenticated)

    def perform_create(self, serializer):
        """Sets the user profile to loged in user"""
        # launhes every time we make HTTP POST request
